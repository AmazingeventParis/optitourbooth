...
import maintenanceRoutes from './maintenance.routes.js'; // TEMP — à retirer après réparation fantômes
...
router.use('/maintenance', maintenanceRoutes); // TEMP — à retirer après réparation fantômes
